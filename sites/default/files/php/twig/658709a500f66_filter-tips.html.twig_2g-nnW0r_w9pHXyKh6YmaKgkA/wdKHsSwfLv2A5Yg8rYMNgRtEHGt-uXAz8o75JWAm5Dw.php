...
class __TwigTemplate_d5640ea23e09eb02908809f08880ad18 extends Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/bootstrap5/templates/content-edit/filter-tips.html.twig", "C:\\xampp\\htdocs\\drupal\\drupal-10.1.4\\themes\\bootstrap5\\templates\\content-edit\\filter-tips.html.twig");
    }
